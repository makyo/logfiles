# Generated by Django 2.0.4 on 2018-04-27 00:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_type', models.CharField(choices=[('_DEF', 'Default (uncategorized)'), ('IM', 'Instant Message'), ('Meta', 'Metadata/system message'), ('Say', 'Say/regular message'), ('Pose', 'Pose/`/me` message')], default='_DEF', max_length=4)),
